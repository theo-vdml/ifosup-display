<script setup lang="ts">
    ...
    const deleteRoom = () => {
        if (confirm('Êtes-vous sûr de vouloir supprimer ce local ? Cette action est irréversible.')) {
            ...
            router.delete(rooms.destroy(props.room.id).url);
        }
    };
        ...
        <div class="px-4 py-6 w-full max-w-5xl mx-auto">
            <div class="flex flex-col space-y-6">
                <div class="flex items-start justify-between">
                    <Heading :title="room.name" description="Consultez les détails du local." />
                    <Link :href="rooms.edit(props.room.id).url"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex flex-col space-y-1">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    Supprimer définitivement ce local et toutes les données associées.
                                </p>
                            </div>
